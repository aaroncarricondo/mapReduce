...
class cos_backend():
    ...
    def __init__(self, config):
        ...
        self.cos_client = ibm_boto3.client('s3', aws_access_key_id= access_key,
    ...
    def put_object(self, bucket_name, key, data):
        try:
            ...
            #status = 'OK' if res['ResponsiveMetaData']['HTTPStatusCode'] == 200 else 'Error'
